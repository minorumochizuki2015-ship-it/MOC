...
{
    public APKAnalyzer(str apk_path)
    {
        this.apk_path = apk_path;
        this.output_dir = Path.Combine(Path.GetTempPath(), "APKAnalyzer");
        this.dynamic_analyzer = new DynamicAnalyzer(apk_path);
    }
